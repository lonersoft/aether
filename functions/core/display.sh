...
function display {
    ...
    echo -e "\e[38;2;195;144;230m  Memory: \e[90m$(free | awk '/^Mem:/ {printf "%.2f GiB out of %.2f GiB", $3/1024/1024, $2/1024/1024}')\e[0m  \e[92m$(free | awk '/^Mem:/ {printf "(%.2f%%)", $3/$2*100}')\e[0m"
