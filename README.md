...
- [x] ❓ organize the functions of the egg, current egg is somewhat difficult to understand in my opinion
- [ ] ⌨️ don't make the startup tab filled with admin only variables, perhaps like a .json file that people can host themselves?
